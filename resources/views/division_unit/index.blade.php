...
<div class="d-flex align-items-center mb-3">
    <h1 class="h3 mb-0 me-auto">Division/ Unit</h1>
</div>

<!-- Card with table -->
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center bg-success text-white">
        <div><i class="fa fa-table me-2"></i> Division/ Unit</div>
        <div class="small">
        ...
        <div class="table-responsive">
            <table id="dataTable" class="table table-striped table-bordered display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $unit->division_unit }}</td>
                        <td>
                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#updateUnitModal-{{ $unit->id }}">Edit</button>
                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteUnitModal-{{ $unit->id }}">Delete</button>
                        </td>
                    </tr>
                            ...
                            <div class="modal-content">
                                <form action="{{ route('units.update', $unit->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <input type="text" class="form-control" name="division_unit" value="{{ $unit->division_unit }}" required>
                                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('units.destroy', $unit->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        Are you sure you want to delete "{{ $unit->division_unit }}"?
                                    </div>
                                    <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('units.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="division_unit" class="form-label">Unit Name</label>
                        <input type="text" class="form-control" name="division_unit" id="division_unit" required>
                    </div>
                </div>
